<!--
  Mirrored from ruvnet/RuVector docs/architecture/decisions/ADR-004-rvf-format.md on 2026-08-02
  — canonical source lives upstream; do not edit here.
-->

> **Mirrored copy.** Canonical source: [`ruvnet/RuVector` → `docs/architecture/decisions/ADR-004-rvf-format.md`](https://github.com/ruvnet/RuVector/blob/main/docs/architecture/decisions/ADR-004-rvf-format.md), copied 2026-08-02. Edits belong upstream, not in rvQR.
