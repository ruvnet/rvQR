<!--
  Mirrored from ruvnet/RuVector docs/adr/ADR-057-federated-rvf-transfer-learning.md on 2026-08-02
  — canonical source lives upstream; do not edit here.
-->

> **Mirrored copy.** Canonical source: [`ruvnet/RuVector` → `docs/adr/ADR-057-federated-rvf-transfer-learning.md`](https://github.com/ruvnet/RuVector/blob/main/docs/adr/ADR-057-federated-rvf-transfer-learning.md), copied 2026-08-02. Edits belong upstream, not in rvQR.
